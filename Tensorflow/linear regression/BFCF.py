#bucketized_feature_and_cross_feature (BFCF)
import math
...
def construct_feature_columns():
  ...
  """
    ...
    bucketized_latitude = tf.feature_column.bucketized_column(
        latitude,
        boundaries=get_quantile_based_boundaries(training_examples["latitude"],
                                                 10))
...
def train_model(learning_rate, steps, batch_size, feature_columns,
  ...
  '''
    ...
    # Use the (Follow the regularized leader) FTRL algorithem
